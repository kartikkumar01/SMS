...
<main>
    ...
    <form id="signupForm" class="shadow-box-light dark:shadow-box-dark transition  mt-5 rounded-lg w-[95%] max-w-[500px] mx-auto flex flex-col p-2 gap-6 md:px-7 ">
        ...
        <input type="text" id="fullname" name="fullname" placeholder="Full Name" class="border rounded-sm focus:outline-2 focus:border-transparent outline-primary-light">
        ...
        <div class="border flex items-center pr-2 rounded-sm focus-within:outline-2 focus-within:border-transparent outline-primary-light">
            <input id="password" name="password" type="password" placeholder="password" class="w-full outline-none">
            <i id="showHidePasswordBtn" class="cursor-pointer fa-solid fa-eye-slash"></i>
        </div>
        <input type="password" id="confirmPassword" placeholder="confirm password" class="border rounded-sm focus:outline-2 focus:border-transparent outline-primary-light">
