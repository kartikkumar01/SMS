...
<body class="dark:bg-hsecondary-dark dark:text-text-dark text-text-light bg-bg-light text-body-desktop">
    ...
    <main class="w-[93%] md:w-[70%] mx-auto">
        ...
        <section class="bg-white dark:bg-gray-800 p-3 md:p-8  rounded-lg shadow-lg mb-8">
            ...
            <iframe class="w-full h-50 md:h-110 rounded-lg" src="https://www.youtube.com/embed/b6NP2fIThPQ?si=8GjntTe6rvfRvt5T" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        ...
        <section class="bg-white dark:bg-gray-800 p-3 md:p-8  rounded-lg shadow-lg mb-8">
            ...
            <iframe class="w-full h-50 md:h-110 rounded-lg" src="https://www.youtube.com/embed/9MdbLP6hQ7E?si=KadfdrHmB17IQWhd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p class="text-lg leading-relaxed mt-4">
            ...
            <section class="bg-white dark:bg-gray-800 p-3 md:p-8  rounded-lg shadow-lg mb-8">
                ...
                <iframe class="w-full h-50 md:h-110 rounded-lg" src="https://www.youtube.com/embed/iIVBkyRTqXk?si=ncFNtGqDmwCm87rK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                <p class="text-lg leading-relaxed mt-4">
